...
- 打造开源社区、吸纳行业顶级开源人才，面向未来、以专业、低成本、高质量、高效率的方式快速交付项目

- 当前项目为示例项目、投入 人力 1建模 + 1前端，2000元的成本、三天从零定制交付

- 国内首款 - 开源Ai数字孪生编辑器 - 面向未来 - 引领时代 2026-5-25 发布

- 推荐node 22+ pnpm安装 [cnpm npm yarn] 等安装报错请添加，如npm i --force 强制安装。
- 本地开发：执行 `pnpm dev` 启动 Vite 开发服务器。

- 简易安装、快速开发、高度自定义, 扩展化, Ai协同开发3D组件的低代码组态编辑器。

- 开发者可无限扩展组件库，所有组件均为 Ai 引用下方开源案例撰写。

- 原生Three.js Cesium.js 案例 https://github.com/z2586300277/three-cesium-examples 2000 Star ⭐

- 编辑器定制，技术帮助，学习分享，招贤纳士，交流合作，开源分享可联系我 🍉。
