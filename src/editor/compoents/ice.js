...
export default {
    ...
    create: function (storage, { scene }) {
        ...
        const crackMap = textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + 'images/shader/cracks.png')
        crackMap.wrapS = THREE.RepeatWrapping
        crackMap.wrapT = THREE.RepeatWrapping
        const perlinMap = textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + 'images/shader/smokeMap.png')
