...
const create = (_, { scene }) => {
    ...
    const pointsMaterial = new THREE.PointsMaterial({
        color: 0x409eff,
        size: 0.4,
        map: new THREE.TextureLoader().load(`https://z2586300277.github.io/3d-file-server/` + 'images/texture/circle.png'),
        alphaMap: new THREE.TextureLoader().load(`https://z2586300277.github.io/3d-file-server/` + 'images/texture/circle.png'),
        transparent: true,
        depthWrite: false,
    ...
    pointsMaterial.onBeforeCompile = ((shader) => {
        ...
        shader.uniforms.uPerlinTexture = { value: new THREE.TextureLoader().load(`https://z2586300277.github.io/3d-file-server/` + 'images/texture/noise.png') };
