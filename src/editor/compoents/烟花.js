...
export default {
    ...
    create(_, {scene}) {
        ...
        const textures = [
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/1.png"),
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/10.png"),
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/3.png"),
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/4.png"),
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/5.png"),
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/6.png"),
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/7.png"),
            textureLoader.load(`https://z2586300277.github.io/3d-file-server/` + "threeExamples/particle/particleFire/8.png"),
        ];

                const group = new THREE.Group();
        // 创建一个隐藏的矩形
        const hiddenGeometry = new THREE.BoxGeometry(5, 5, 5);
        ...
        // 设置定时器创建烟花
        const intervalId = setInterval(radomCreateFireWork, 600);
...
/**
 * title: Fire
 * author: FFMMCC https://coderfmc.github.io/three.js-demo/fmc-web-3d/
 */
