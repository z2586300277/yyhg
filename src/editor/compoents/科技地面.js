...
export default {
    ...
    create(_, {scene}) {
        ...
        // 创建海洋纹理地面
        const oceanTexture = new THREE.TextureLoader().load(`https://z2586300277.github.io/3d-file-server/` + "/images/bluebg.png")
...
/**
 * title: TachnologyFloor
 * author: flowers-10 https://github.com/flowers-10
 * refer: https://three-auto.vercel.app/?tab=floor 
 * improver: Elegant https://z2586300277.github.io/ 
 */
